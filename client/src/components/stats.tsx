...
export default function StatsCard() {
  return (
    <div className="flex flex-col gap-4 h-full">
      <div className="bg-[#0b0b0b] border border-zinc-800/50 rounded-xl p-4 shadow-2xl">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-zinc-400 text-xs font-semibold uppercase tracking-wider">Categories</h3>
          <span className="text-zinc-600 text-[10px] font-mono">381 TOTAL</span>
        </div>
            ...
            <div key={cat.name} className="space-y-1.5">
              <div className="flex justify-between text-[11px] font-medium">
                ...
                <span className="text-zinc-500">
                  {cat.percentage}% <span className="text-zinc-700 ml-1">{cat.count}</span>
                </span>
              </div>
      ...
      <div className="bg-[#0b0b0b] border border-zinc-800/50 rounded-xl p-4 flex-1">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-zinc-400 text-xs font-semibold uppercase tracking-wider">Sources</h3>
        ...
        <div className="space-y-3 text-[11px]">
          ...
          <div className="space-y-2">
            ...
            <div className="ml-6 space-y-2 text-zinc-500 border-l border-zinc-800 pl-3">
...
function SourceItem({
  ...
  return (
    <div className={`flex justify-between items-center ${active ? 'text-zinc-200' : 'text-zinc-500'}`}>
      <div className="flex items-center gap-2">
        {icon}
        <span>{label}</span>
